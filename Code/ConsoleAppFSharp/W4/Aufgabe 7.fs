...
let kehrwert (zaehler, nenner) = 
  normiereKuerze (nenner, zaehler)

let multk b f = 
  let zaehler, nenner = b
  normiereKuerze (zaehler*f, nenner*f)

let mult b1 b2 = 
  let zaehler1, nenner1 = b1
  let zaehler2, nenner2 = b2
  normiereKuerze (zaehler1*zaehler2, nenner1*nenner2)

let divk b divisor = 
  let zaehler, nenner = b
  normiereKuerze (zaehler, nenner * divisor)

let div b1 b2 = 
  let zaehler1, nenner1 = b1
  let zaehler2, nenner2 = b2
  normiereKuerze (zaehler1*nenner2, nenner1*zaehler2)

let add b1 b2 = 
  let zaehler1, nenner1 = b1
  let zaehler2, nenner2 = b2
  normiereKuerze (zaehler1*nenner2 + zaehler2*nenner1, nenner1*nenner2)
